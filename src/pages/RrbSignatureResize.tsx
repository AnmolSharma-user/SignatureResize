...
const RrbSignatureResize = () => {
  ...
  return (
    <TooltipProvider>
      <Helmet>
        <title>RRB Signature Resize Tool | Free Online | SignatureResize.pro</title>
        ...
        <link rel="canonical" href="https://signatureresize.pro/rrb-signature-resize" />
        ...
        <meta property="og:url" content="https://signatureresize.pro/rrb-signature-resize" />
