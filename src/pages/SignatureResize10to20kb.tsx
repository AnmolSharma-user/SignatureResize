...
const SignatureResize10to20kb = () => {
  ...
  return (
    <TooltipProvider>
      <Helmet>
        <title>Signature Resize 10 to 20 KB | Free Online Tool | signaturereform.com</title>
        ...
        <link rel="canonical" href="https://signaturereform.com/signature-resize-10-to-20-kb" />
        ...
        <meta property="og:url" content="https://signaturereform.com/signature-resize-10-to-20-kb" />
