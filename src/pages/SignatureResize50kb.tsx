...
const SignatureResize50kb = () => {
  ...
  return (
    <TooltipProvider>
      <Helmet>
        <title>Signature Resize 50KB | Free Online Tool | SignatureResize.pro</title>
        ...
        <link rel="canonical" href="https://signatureresize.pro/signature-resize-50-kb" />
        ...
        <meta property="og:url" content="https://signatureresize.pro/signature-resize-50-kb" />
