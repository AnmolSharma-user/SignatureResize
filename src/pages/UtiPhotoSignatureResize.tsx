...
const UtiPhotoSignatureResize = () => {
  ...
  return (
    <TooltipProvider>
      <Helmet>
        <title>UTI Photo Signature Resize Tool | Free Online | SignatureResize.pro</title>
        ...
        <link rel="canonical" href="https://signatureresize.pro/uti-photo-signature-resize" />
        ...
        <meta property="og:url" content="https://signatureresize.pro/uti-photo-signature-resize" />
