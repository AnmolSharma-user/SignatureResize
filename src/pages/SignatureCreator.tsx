...
const SignatureCreator = () => {
  ...
  if (creationMode !== 'select') {
    return <div className={`min-h-screen bg-background ${darkMode ? 'dark' : ''} font-inter`}>
        <Helmet>
          <title>Signature Creator - Draw or Type Your Signature | SignatureResize.pro</title>
          ...
          <link rel="canonical" href="https://signatureresize.pro/signature-creator" />
        </Helmet>
  ...
  return <div className={`min-h-screen bg-background ${darkMode ? 'dark' : ''} font-inter relative overflow-hidden`}>
      <Helmet>
        <title>Online Signature Creator - Create Digital Signatures Free | SignatureResize.pro</title>
