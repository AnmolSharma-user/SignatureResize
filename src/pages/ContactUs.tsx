...
const ContactUs = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    alert('Thank you for your message! We will get back to you soon at signaturereform.com@gmail.com');
                      ...
                      <div className="space-y-4">
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            ...
                            <p className="text-gray-600 dark:text-gray-300">signaturereform.com@gmail.com</p>
                          </div>
                        </div>
