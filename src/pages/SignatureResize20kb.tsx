...
const SignatureResize20kb = () => {
  ...
  return (
    <TooltipProvider>
      <Helmet>
        <title>Signature Resize 20KB | Free Online Signature Resizer | signaturereform.com</title>
        ...
        <link rel="canonical" href="https://signaturereform.com/signature-resize-20kb" />
        ...
        <meta property="og:url" content="https://signaturereform.com/signature-resize-20kb" />
