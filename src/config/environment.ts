...
export const environment = {
  ...
  baseUrl: import.meta.env.VITE_BASE_URL || 'https://signaturereform.com',
  appName: 'signaturereform.com',
  version: '1.0.0'
};

export const seoConfig = {
  defaultTitle: 'Free Signature Resizer for SSC/PAN/GATE | signaturereform.com',
